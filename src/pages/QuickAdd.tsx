          ...
          {showProjectPicker && (
            ...
            >
              ...
              <button
                ...
                className={`w-full flex items-center gap-2 px-2.5 py-[7px] rounded-lg text-[12px] text-left cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-accent-blue ${
                  projectId === null
