    ...
    <div className="flex gap-2">
      ...
      <div className="flex flex-col justify-between py-1 pr-1 w-8 flex-shrink-0">
        {yLabels.map((h) => (
          <span
            key={h}
            className="text-[10px] text-black/25 tabular-nums text-right"
          >
            {h}h
          </span>
        ))}
        ...
        {weekDates.map((date, i) => {
          ...
          return (
            <div key={date} className="flex-1 flex flex-col items-center">
              ...
              {/* Day label */}
              <span className="text-[10px] text-black/35 mt-1.5">
                {DAY_NAMES[i]}
              </span>
            </div>
          );
...
function ProjectProgressRow({
  ...
  return (
    <div className="flex items-center gap-3 py-2">
      ...
      />
      <span className="text-[13px] text-[#2c2a35] flex-1 truncate">
        {project.name}
      </span>
    </div>
  );
                ...
                <div className="bg-white border border-black/[0.08] rounded-[10px] px-5 py-3">
                  {recentDates.slice(0, 3).map((date) => {
                    ...
                    return (
                      ...
                      >
                        <div className="text-[11px] font-medium text-black/40 mb-1">
                        ...
                        {tasks.slice(0, 3).map((task) => (
                          ...
                          >
                            <span className="text-[11px] text-[#3a9e6e]">
                              ✓
                            </span>
                            <span className="text-[12px] text-[#2c2a35] truncate">
                              {task.title}
                            </span>
                        ...
                        {tasks.length > 3 && (
                          <span className="text-[10px] text-black/25 mt-0.5 block">
                            +{tasks.length - 3} more
                          </span>
                        )}
                      </div>
